      ...
      <div style={{
        ...
        <div style={{ textAlign: "center", marginBottom: 32 }}>
          <svg width="48" height="48" viewBox="0 0 32 32" fill="none" style={{ marginBottom: 16 }}>
            ...
            <rect x="4" y="4" width="24" height="24" rx="1" fill="rgba(212,160,23,0.05)" stroke="#d4a017" strokeWidth="0.5" strokeDasharray="2 1" />
          ...
          <div style={{ fontSize: 10, letterSpacing: 6, color: "rgba(212,160,23,0.3)", marginTop: 6, fontFamily: "monospace" }}>REAL ESTATE CRM</div>
          <div style={{ width: "100%", height: 1, background: "linear-gradient(90deg, transparent, rgba(212,160,23,0.2), transparent)", margin: "16px 0 0" }} />
        </div>
        <form onSubmit={handleLogin}>
          <div style={{ marginBottom: 16 }}>
            <label style={{ fontSize: 10, fontWeight: 600, color: "rgba(212,160,23,0.5)", display: "block", marginBottom: 6, letterSpacing: 3, fontFamily: "monospace" }}>EMAIL</label>
          ...
          <div style={{ marginBottom: 24 }}>
            <label style={{ fontSize: 10, fontWeight: 600, color: "rgba(212,160,23,0.5)", display: "block", marginBottom: 6, letterSpacing: 3, fontFamily: "monospace" }}>PASSWORD</label>
          ...
          <button type="submit" disabled={loading} style={{
            ...
            background: loading ? "rgba(212,160,23,0.1)" : "rgba(212,160,23,0.15)",
            color: "#d4a017", border: "1px solid rgba(212,160,23,0.4)",
            cursor: loading ? "not-allowed" : "pointer", fontFamily: "monospace",
            textTransform: "uppercase" as const,
            boxShadow: loading ? "none" : "0 0 15px rgba(212,160,23,0.1)",
